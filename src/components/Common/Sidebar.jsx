...
const Sidebar = () => {
  ...
  return (
    <div className="relative">
      <aside
        className={`fixed top-0 left-0 h-screen bg-[#003e3f] text-white z-40 sm:w-64 w-60 shadow-lg transition-transform duration-300 ease-in-out ${
          isSidebarOpen ? "translate-x-0" : "-translate-x-full"
        } sm:translate-x-0`}
      >
        <div className="w-full flex items-center justify-center py-7 mb-8 border-b border-gray-700">
